  ...
  try {
    ...
    const records = await query(`
      SELECT 
        ...
        uf.free_days_limit AS "freeDaysLimit",
        uf.free_entries_limit AS "freeEntriesLimit",
        uf.free_entries_used AS "freeEntriesUsed",
        uf.can_sell AS "canSell",
        uf.can_purchase AS "canPurchase",
        uf.can_repair AS "canRepair",
        uf.can_reports AS "canReports",
